 ...
 * @version $Id: VelocityMultipleLayoutViewResolver.java, v 0.1 2009-9-18
 *          下午05:12:50 Exp $
 */
public class VelocityMultipleLayoutViewResolver extends VelocityViewResolver {
	 ...
	 * 
	 * @param layoutKey
	 *            the name of the key you wish to use in name=sean won screen
	 ...
	 * 
	 * @see
	 * org.springframework.web.servlet.view.velocity.VelocityViewResolver#buildView
	 * (java.lang.String)
	 */
	protected AbstractUrlBasedView buildView(final String viewName)
		...
		if (!this.mappings.isEmpty()) {
			for (Map.Entry<String, String> entry : this.mappings.entrySet()) {
				...
				// 获取正则表达式
				String mappingRegexp = StringUtil.replace(entry.getKey(), "*",
						".*");
