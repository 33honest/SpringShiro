package cc.project.lnj.ueditor.hunter;
...
import cc.project.lnj.ueditor.define.MultiState;
...
public class FileManager {
    ...
    public FileManager(Map<String, Object> conf) {
        ...
        this.staticPath = (String)conf.get("staticPath");
        this.projectPath = (String)conf.get("projectPath");
        this.dir = this.rootPath + staticPath + (String) conf.get("dir");
